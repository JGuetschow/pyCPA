...
def read_wide_csv_file(file, folder, col_rename: dict = {}, col_defaults: dict = {}, 
    ...
    :obj:`scmdata.dataframe.ScmDataFrame`
        scmDataFrame with the read data
...
def read_wide_csv_file_pd(file, folder, col_rename: dict = {}, col_defaults: dict = {}, 
                       filter_keep: dict = {}, filter_remove: dict = {}, 
                       meta_mapping: dict = {}) -> pd.DataFrame:
    """
    This function reads a csv file and returns the data as a pamdas Dataframe. It is used by 
